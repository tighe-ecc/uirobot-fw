...
setpoint_time = df_setpoint['Time']
setpoint_position = df_setpoint['Position']
...
ax1.plot(setpoint_time, setpoint_position, label='Setpoint Position', color='tab:blue')
